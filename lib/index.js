...
var _KeyedObjectSchema = require('normalizr/lib/KeyedObjectSchema');
...
function denormalizeIterable(items, entities, schema, bag) {
  ...
  if ((0, _isObject2.default)(items)) {
    return Object.keys(items).map(function (key) {
      return denormalize(items[key], entities, itemSchema, bag);
    });
  }
...
function denormalizeKeyedObject(items, entities, schema, bag) {
  var keyName = schema.getKeyedObjectStoredKeyName();
